...
\begin{enumerate}
        ...
        \item $\Gamma$ es el conjunto finito de símbolos de entrada, también conocido como alfabeto de la máquina\footnote{Denotar que el espacio en blanco no se considera un elemento del alfabeto, ya que es el
