...
\begin{enumerate}
    ...
    \item Para cada $n$ dado, una DEDUCCIÓN de $Sb\left(r
            ...
            \right)$.
\end{enumerate}
Es decir, una decisión formal de $17 \text{ Gen } r$ tendría comoconsecuencia la exhibición efectiva de una $\omega$-inconsistencia.
...
de ellas por ELEVACION D E TIPO). Naturalmente, cada clase finita $K$ es recursiva primitiva. Sea $a$ el mayor número contenido en $K$. Entonces ocurre para $K$ que
\begin{equation}
