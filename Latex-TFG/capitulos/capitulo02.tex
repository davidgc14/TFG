...
\begin{teorema} \label{teo:TeoremaV}
    ...
    \begin{equation} \label{eq:Teo5-1}
    ...
    \begin{equation} \label{eq:Teo5-2}
...
\begin{proof}
    ...
    $r_1, \dots, r_k$, tales que \eqref{eq:Teo5-1} y \eqref{eq:Teo5-2} valen. Los procesos de definición (sustitución y definición recursiva) mediante los 
    ...
    de su interpretación intuitiva, sino sólo por su estructura puramente formal.} para el cual puede probarse sin dificultad que valen \eqref{eq:Teo5-1} 
    y \eqref{eq:Teo5-2}, haciendo uso de la hipótesis inductiva. Un SIGNO RELACIONAL $r$, que corresponde\footnote{Que, por tanto, en la interpretación 
