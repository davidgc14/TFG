...
\begin{proof}
    ...
    \end{equation}
    es deducible (por la deducibilidad de $\forall x \pi \exists y (\varphi \wedge \text{Fx} \vee \lnot \text{Fy})$
    \footnote{Además de por el lema 4 de los resultados aportados por Hilbert en \cite{hilbert1962elementos}.}).
