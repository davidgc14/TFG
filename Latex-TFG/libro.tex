...
\newcommand{\miTitulo}{El programa de Hilbert. Teoremas de Incompletitud de Gödel\xspace}
\newcommand{\miNombre}{David García Curbelo\xspace}
...
\setpartpreamble[c][0.75\linewidth]{%
  ...
  % Aqui metemos resumen del programa de hilbert
}
\part{El programa de Hilbert} % Dividir un libro en partes OPCIONAL
...
\setpartpreamble[c][0.75\linewidth]{%
	\bigskip % Deja un espacio vertical en la parte superior
  %Aqui metemos resumen de los teoremas
}

\part{Los teoremas de incompletitud de Gödel}
...
\setbibpreamble{
  Para escribir la parte biográfica de Hilbert y su respectivo programa, me he basado fundamentalmente en \cite{gray2000hilbert}
  \footnote{Se puede leer una versión en español, \cite{gray2003reto} publicada unos años después.} y \cite{Leo1998}. También me han acompañado 
  obras como \cite{Zach_2007} y \cite{alma991014322964704990} (para el estudio de los avances históricos del programa), y también 
  \cite{Fer_Castro_2020}. En menor medida, me han ayudado a entender mejor la persectiva del programa obras como \cite{stewart1987problems},
  \cite{browder1976mathematical} y \cite{van1993strong}.

  Para tratar la crisis fundacional me he fundamentado en \cite{mancosu1997brouwer}, \cite{kreisel1976have} y en \cite{fernandez2012esperando}.
  En un segundo plano también han sido consultadas obras como \cite{toranzos1949panorama} o \cite{kline2000matematicas}, entre otras.

  En relación con las obras de Gödel, destacar los dos pilares \cite{an1910principia} y \cite{godel1986collected} en los que me he 
  sustentado principalmente, además de obras como \cite{alcaraz2000logica} y \cite{smith2013introduction}. Se obvian aquí obras de carácter divulgativo que han tenido un menor
  peso en el desarrollo del trabajo.

  Por último, en el desarrollo de temas fundamentales en relación con Turing, he basado mi lectura en obras como \cite{hodges1983alan}, \cite{sipser2006introduction}
  y \cite{chaitin1998limits}, las cuales me han ayudado a tener una visión muy completa acerca de las máquinas de Turing y sus implicaciones en las
  matemáticas. De forma adicional, me he apollado en obras como \cite{mosterin2000logicos}, que me ha dado una visión lineal del flujo del problema.
